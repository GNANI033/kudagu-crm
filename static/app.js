...
function pricingCalcDefaultProfile(name='Untitled Profile'){ return {id:0,name,inputs:{...PRICING_CALC_DEFAULT_INPUTS},extraCosts:[],variants:PRICING_CALC_DEFAULT_VARIANTS.map(v=>({...v})),rows:pricingCalcProductRows(),roundToFive:false,nonBulkMarginMode:'markup',createdAt:0,updatedAt:0}; }
